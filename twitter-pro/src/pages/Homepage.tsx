    ...
    <div className="bg-white h-screen overflow-auto col-start-2 col-span-3 border-l-2 border-gray-300">
      ...
      <div className="flex">
        <div className="m-2 w-10 py-1">
            <img className="inline-block h-10 w-10 rounded-full" src={profileImg} alt=""/>
        </div>
        <div className="flex-1 px-2 pt-2 mt-2">
            <textarea className=" bg-transparent text-gray-400 font-medium text-lg w-full" rows={2} cols={50} placeholder="What's happening? "
        ...
        <div className="w-64 px-2">
            ...
            <div className="flex items-center">
                <div className="flex-1 text-center px-1 py-1 m-2">
                    <a href="" className="mt-1 group flex items-center text-blue-400 px-2 py-2 text-base leading-6 font-medium rounded-full hover:bg-blue-200 hover:text-blue-500">
        ...
        <a href="" className="flex-shrink-0 group block">
            <div className="flex items-center">
                ...
                <div className="ml-3  flex justify-around gap-96">
                    ...
                    <button onClick={() => deleteID(item.id)}><img src={moreImag}/></button>
                    </div>
                </div>
            </div>
        </a>
...
<article className="hover:bg-gray-100 transition duration-350 ease-in-out">
    <div className="flex flex-shrink-0 p-4 pb-0">
        <a href="" className="flex-shrink-0 group block">
            <div className="flex items-center">
                <div>
                    <img className="inline-block h-10 w-10 rounded-full" src="https://pbs.twimg.com/profile_images/1629555978948452354/EhnwIhIX_400x400.jpg" alt=""/>
                </div>
                <div className="ml-3 flex justify-around gap-96">
    ...
    <div className="pl-16">
        <p className="text-base width-auto font-medium flex-shrink">
        <a href="" className="text-blue-400">#طويق_Talk</a>
                    <br />
                            لقاء الأسبوعي 
                    منهجيات توليد الأفكار وبناء الشركات التقنية، مع 
                    <br />
  ...
  <div className="md:flex-shrink pr-6 pt-3 ">
            ...
            <img className=" w-1/2" src="https://pbs.twimg.com/media/F4jf--VXoAA5004?format=jpg&name=medium" alt=""/>
        </div>
        </div>
        <div className="flex items-center py-4">
            <div className="flex-1 flex items-center text-xs text-gray-400 hover:text-blue-400 transition duration-350 ease-in-out">
...
<article className="hover:bg-gray-100 transition duration-350 ease-in-out">
    <div className="flex flex-shrink-0 p-4 pb-0">
        <a href="" className="flex-shrink-0 group block">
            <div className="flex items-center">
                <div>
                    <img className="inline-block h-10 w-10 rounded-full" src="https://1fid.com/wp-content/uploads/2022/06/Twitter-profile-picture-4-720x720.jpg" alt=""/>
                </div>
                <div className="ml-3  flex justify-around gap-96">
