...
export default function Homepage() {
  ...
  < >
   ...
   <div className=" bg-white h-screen col-start-1 col-end-2">
    ...
    <div className="bg-white h-screen col-start-2 col-span-3 border-l-2 border-gray-800">
   ...
   <div className="bg-white h-screen col-end-6 col-span-1 border-l-2 border-gray-800">
   <Acountbar/>
   </div>
